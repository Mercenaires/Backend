 ...
 * Modifier ici
 * 
 * try (FileWriter csvWriter = new
 * FileWriter("src/main/java/org/example/models/games_mbti.csv")) { // Chemin
 * relatif
 * 
 * // Écrire l'en-tête du fichier CSV
 * csvWriter.append("Nom du jeu,Type MBTI\n");
 * 
 * // Attendez la visibilité des éléments contenant les informations de chaque
 * jeu
 * wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(
 * ".css-1fe0c1")));
 * 
 * // Récupérer tous les blocs de jeux
 * List<WebElement> gameBlocks =
 * driver.findElements(By.cssSelector(".css-1fe0c1"));
 * 
 * for (WebElement gameBlock : gameBlocks) {
 * // Récupérer le nom du jeu et le type MBTI
 * WebElement mbtiElement =
 * gameBlock.findElement(By.cssSelector("h2.chakra-heading.css-1brxr6x"));
 * WebElement gameElement =
 * gameBlock.findElement(By.cssSelector("h2.chakra-heading.css-zzio9a"));
 * 
